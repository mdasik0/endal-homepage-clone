...
const PageGenTitle = ({ title_part_one, title_part_two, description }: PageGenTitleProps) => {
  return (
    <div className="w-[760px] mx-auto mt-[100px] mb-[48px] text-center flex flex-col gap-5  items-center justify-center">
      <h1 className="text-[44px] leading-[56px]">
        {title_part_one} {title_part_two && <br />} {title_part_two}
      </h1>
