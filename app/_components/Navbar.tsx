...
const Navbar = () => {
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] items-center px-4 w-full gap-10 h-[72px]">
      {/* logo */}
      ...
      <div className="flex items-center justify-end gap-3">
        <button className="hover:bg-stone-500 duration-200 cursor-pointer bg-[#262626] text-white font-medium p-2.5 px-3.5 rounded-xl shadow-[0_0px_18px_rgba(255,255,255,0.9)]">
          Try Today
        </button>
        <button className="hover:bg-stone-500 duration-200 cursor-pointer bg-[#262626] text-white font-medium p-2.5 px-3.5 rounded-xl">
          Sign In
        </button>
      </div>
    </div>
